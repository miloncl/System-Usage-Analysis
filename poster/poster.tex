...
\\
    ...
    \begin{column}{\colwidth}
      ...
      \begin{block} {\huge{Conclusions}}     
        {
          \fontsize{37pt}{44.4pt} \selectfont
                % 1.  \textit{Foreground Window} provides the most applicable data for further analysis \\
                ...
                % \\3. Feature engineering, input RNN libraries, and hyperparameter tuning greatly influence the model performance \\
