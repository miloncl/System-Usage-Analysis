      ...
      \vspace*{-\baselineskip}
        { \fontsize{32pt}{38.4pt} \selectfont
          \begin{table}
            ...
            \begin{tabular}{l l l l}
              \toprule
              \multicolumn{1}{|l|}{\hspace*{2cm}\textbf{Other Models}}                                                                                                         & \multicolumn{1}{|l|}{\hspace*{0.3cm} \textbf{Design (N=nodes)}} & \multicolumn{1}{|l|}{\hspace*{0.4cm} \textbf{Eval Bins}} & \multicolumn{1}{|l|}{\hspace*{0.75cm} \textbf{Performance}} \\
              \midrule
              ...
              \multicolumn{1}{|l|}{\centering \begin{tabular}[c]{@{}l@{}} \hspace*{0.75cm} [0, 0.01] \\ \hspace*{0.75cm} (0.01, 0.02]  \\ \hspace*{0.75cm} (0.02, 0.2] \\ \hspace*{0.75cm} (0.2, max] \end{tabular}}                            &
